...
//  FractalScape
//
//  Created by Taun Chapman on 11/16/14.
...
+ (void)drawLineEditControllerWithFrame: (CGRect)frame
{
    ...
    [mainLinePath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 82, CGRectGetMinY(frame) + 175)];
    [mainLinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 175, CGRectGetMinY(frame) + 175)];
    [mainLinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 241, CGRectGetMinY(frame) + 109)];
    [FractalScapeIconSet.symbolFillColor setStroke];
    ...
    [mainInnerDashedPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 241, CGRectGetMinY(frame) + 109)];
    [UIColor.whiteColor setStroke];
    mainInnerDashedPath.lineWidth = 2;
    CGFloat mainInnerDashedPattern[] = {2, 4};
    ...
    //// WidthDragLine Drawing
    UIBezierPath* widthDragLinePath = UIBezierPath.bezierPath;
    [widthDragLinePath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 133.5, CGRectGetMinY(frame) + 149.5)];
    [widthDragLinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 133.5, CGRectGetMinY(frame) + 203.5)];
    [UIColor.whiteColor setFill];
    [widthDragLinePath fill];
    [UIColor.lightGrayColor setStroke];
    widthDragLinePath.lineWidth = 3;
    CGFloat widthDragLinePattern[] = {4, 2};
    [widthDragLinePath setLineDash: widthDragLinePattern count: 2 phase: 0];
    [widthDragLinePath stroke];


    //// WidthDragCircle Drawing
    UIBezierPath* widthDragCirclePath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(frame) + 122.5, CGRectGetMinY(frame) + 138.5, 22, 22)];
    [white70 setFill];
    [widthDragCirclePath fill];
    CGContextSaveGState(context);
    CGContextSetShadowWithColor(context, controlDialShadowOffset, controlDialShadowBlurRadius, [controlDialShadow CGColor]);
    [FractalScapeIconSet.transformActionColor setStroke];
    widthDragCirclePath.lineWidth = 3;
    [widthDragCirclePath stroke];
    CGContextRestoreGState(context);
    ...
    //// LengthDragLine Drawing
    UIBezierPath* lengthDragLinePath = UIBezierPath.bezierPath;
    [lengthDragLinePath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 58.5, CGRectGetMinY(frame) + 174.5)];
    [lengthDragLinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 82.5, CGRectGetMinY(frame) + 174.5)];
    [lengthDragLinePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 82.5, CGRectGetMinY(frame) + 174.5)];
    [UIColor.lightGrayColor setStroke];
    lengthDragLinePath.lineWidth = 3;
    CGFloat lengthDragLinePattern[] = {4, 2};
    [lengthDragLinePath setLineDash: lengthDragLinePattern count: 2 phase: 0];
    [lengthDragLinePath stroke];


    //// LengthDragCircle Drawing
    UIBezierPath* lengthDragCirclePath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(frame) + 46.5, CGRectGetMinY(frame) + 163.5, 22, 22)];
    [white70 setFill];
    [lengthDragCirclePath fill];
    CGContextSaveGState(context);
    CGContextSetShadowWithColor(context, controlDialShadowOffset, controlDialShadowBlurRadius, [controlDialShadow CGColor]);
    [FractalScapeIconSet.transformActionColor setStroke];
    lengthDragCirclePath.lineWidth = 3;
    [lengthDragCirclePath stroke];
    CGContextRestoreGState(context);
