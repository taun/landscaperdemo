...
//  FractalScape
//
//  Created by Taun Chapman on 08/31/15.
...
@property(strong, nonatomic) IBOutletCollection(NSObject) NSArray* metalPak1UpgradeImagePortraitTargets;
@property(strong, nonatomic) IBOutletCollection(NSObject) NSArray* premiumUpgradeImagePortraitTargets;
...
+ (UIImage*)imageOfMetalPak1UpgradeImagePortrait;
+ (UIImage*)imageOfPremiumUpgradeImagePortrait;
